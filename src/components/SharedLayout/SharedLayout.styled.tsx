...
export const Header = styled.div`
  ...
  height: 48px;
  top: 0;
  background: ${(p: { theme: { colors: { bcgHeader: string; }; }; }) => p.theme.colors.bcgHeader};
  z-index: 100;
  box-shadow: ${(p: { theme: { shadows: { headerShadow: string; }; }; }) => p.theme.shadows.headerShadow};
...
export const Footer = styled.div`
  ...
  color: ${(p: { theme: { colors: { textPrimary: string; }; }; }) => p.theme.colors.textPrimary};
  z-index: 100;
  box-shadow: ${(p: { theme: { shadows: { footerShadow: string; }; }; }) => p.theme.shadows.footerShadow};
